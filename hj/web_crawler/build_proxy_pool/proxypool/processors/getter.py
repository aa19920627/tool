...
from web_crawler.build_proxy_pool.proxypool.crawlers import __all__ as crawlers_cls
...
class Getter:
    ...
    def is_full(self):
        ...
        """
        return self.redis.conut() >= PROXY_NUMBER_MAX
    ...
    def run(self):
        ...
        for crawler in self.crawlers:
            logger.info(f'使用爬虫{crawler}获取代理')
